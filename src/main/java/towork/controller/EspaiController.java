...
public class EspaiController {
      ...
      */
      ...
      /**
       *
       * Gestiona l'acció que executa el botó de desar nou estat de l'oferta
       * Només pot canviar l'estat de l'oferta l'admin
       * 
       * @param codiOferta El codi de l'oferta
       * @param formOferta L'objecte de tipus Oferta que rebem del formulari de la vista
       * @param request La petició http
       * @param response La resposta http
       * @return Un objecte ModelAndView que fa referència a la següent vista que mostrarem a l'usuari
       * @throws ServletException
       * @throws IOException 
       */
      ...
      */
       ...
       * Només hi accedeixen usuaris amb rol empresa
       * 
       * @author Daniel Sevilla i junyent
       ...
       * @param response La resposta http
       * @return Un objecte modelandview que representa el model i la vista que mostrarem a l'usuari, amb el formulari d'actualització d'empresa
       * @throws ServletException
       * @throws IOException 
       */
       ...
       * 
       * @author Daniel Sevilla i Junyent
       * @param formEmpresa L'objecte de tipus Empresa que el mètode rep del formulari
       ...
       * 
       * @author Daniel Sevilla i Junyent
       * @param codiCandidat El codi del candidat que rebem com a PathVariable a la url
       * @param request La petició http
       * @param response La resposta http
       * @return Un objecte ModelAndView amb la vista, que contindrà el formulari per modificar el candidat
       * @throws ServletException
       * @throws IOException 
       */
       ...
       * Ha de rebre un objecte de tipus Candidat i invocar el mètode del servei per executar l'update
       * Ha de retornar feedback a l'usuari del resultat
       * Utilitza la classe CandidatFormulari, que és com Candidat però adaptat a les necessitats del formulari
       * 
       * @author Daniel Sevilla i Junyent
      ...
      public ModelAndView ofertesEmpresa(@PathVariable("codiEmpresa") int codiEmpresa, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     public ModelAndView cancelarCandidatura(@PathVariable("codiCandidatura") Integer codiCandidatura) {
      ...
      /**
       * 
       * Ha de retornar els objectes de tipus Experiència de la bbdd associats a un candidat
       * 
       * @author Daniel Sevilla i Junyent
       * @param idCandidat El codi del candidat els objectes Experiència associats al qual ha de retornar el mètode
       * @param request La petició http
       * @param response La resposta http
      ...
      public @ResponseBody  List<Experiencia> getExperienciesPerCandidat(@PathVariable("idCandidat") Integer idCandidat,HttpServletRequest request, HttpServletResponse response) {
     ...
     @RequestMapping(value = "/altaOferta/{codiEmpresa}", method = RequestMethod.GET)
      public ModelAndView altaOferta(@PathVariable("codiEmpresa") Integer codiEmp,HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      public ModelAndView eliminaCandidat(@PathVariable("codiCandidat") Integer codiCandidat,HttpServletRequest request, HttpServletResponse response) {
       ...
       * 
       * @author Daniel Sevilla i Junyent
       * @param formCandidat L'objecte de tipus Candidat que passem al formulari
      ...
      public ModelAndView executaEliminaCandidat(@ModelAttribute("formCandidat") Candidat formCandidat, @PathVariable("codiCandidat") Integer codiCandidat, HttpServletRequest request, HttpServletResponse response) {
      ...
      public ModelAndView eliminaCandidatAdmin(@PathVariable("codiCandidat") Integer codiCandidat, HttpServletRequest request, HttpServletResponse response) {
      ...
      /**
       * 
       * Gestiona la petició d'eliminació d'una empresa, el codi de la qual rebem a la url com a PathVariable
       * 
       * @author Daniel Sevilla i Junyent
      ...
      public ModelAndView eliminaEmpresa(@PathVariable("codiEmpresa") Integer codiEmpresa,HttpServletRequest request, HttpServletResponse response) {
       ...
       * 
       * @author Daniel Sevilla i Junyent
       * @param formEmpresa El formulari que rebem de la vista anterior (confirmació de la baixa)
       * @param codiEmpresa El codi de l'empresa
       * @param request La petició http
       * @param response La resposta http
       * @return 
      ...
      public ModelAndView executaEliminaEmpresa(@ModelAttribute("formEmpresa") Empresa formEmpresa, @PathVariable("codiEmpresa") Integer codiEmpresa, HttpServletRequest request, HttpServletResponse response) {
      ...
      public ModelAndView eliminaEmpresaAdmin(@PathVariable("codiEmpresa") Integer codiEmpresa, HttpServletRequest request, HttpServletResponse response) {
       ...
       * @param request La petició http
       * @param response La resposta http
       * @return Un objecte ModelAndView que conté la referència a la vista que mostrarem a l'usuari
       */
      @RequestMapping(value = "/eliminaOfertaAdmin/{codiOferta}", method = RequestMethod.GET)
      public ModelAndView eliminaOfertaAdmin(@PathVariable("codiOferta") Integer codiOferta, HttpServletRequest request, HttpServletResponse response) {
      ...
      /**
       * 
       * Mètode que gestiona la baixa d'una oferta per part de l'empresa que l'ha creat
       * 
       * @author Daniel Sevilla i Junyent
       * @param codiEmpresa El codi de l'empresa que ha generat l'oferta i que l'esborra
       * @param codiOferta El codi de l'oferta
       * @param request La petició http
       * @param response La resposta http
       * @return Un objecte ModelAndView que conté la referència a la vista que es mostrarà a l'usuari
       */
      @RequestMapping(value = "/eliminaOferta/{codiEmpresa}/{codiOferta}", method = RequestMethod.GET)
      public ModelAndView eliminaOfertaAdmin(@PathVariable("codiEmpresa") Integer codiEmpresa, @PathVariable("codiOferta") Integer codiOferta, HttpServletRequest request, HttpServletResponse response) {
      ...
      */
      ...
      /**
 * 
 * Converteix un item de candidat, de tipus Candidat (el que desem a la bbdd) a tipus CandidatFormulari, apte per utilitzar amb els formularis
