...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <form:form modelAttribute="deleteCandidat" method="post" action="executaEliminarPerfil" style="margin-left:400px" >


                <div class="form-group">
                    <h1>Vols deixar-nos?. Ho sentim :(</h1>
                    <label for="eliminarPerfil">Introdueix l´email, per esborrar el perfil</label>

                    <form:input type="email" class="form-control" placeholder="Email" path="email" style="width: 300px;"/>
            ...
            <p><a class="small-text text-muted" style="margin-left: 650px" href="<spring:url value='/espaiCandidat'/>">Tornar</a></p>
